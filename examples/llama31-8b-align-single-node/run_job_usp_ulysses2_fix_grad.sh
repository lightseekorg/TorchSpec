...
RAY_TEMP_DIR="${RAY_TEMP_DIR:-$RAY_TMP_ROOT/ray_ts_l31_usp_u2_fix_grad_$(id -u)}"
...
RAY_LOG_ROOT="$WORKING_DIR/tmp/ray_usp_u2_fix_grad_${DATE_TAG}_${LOG_SUFFIX}"
...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/llama31_8b_align_usp_ulysses2_fix_grad}"
CACHE_DIR="${CACHE_DIR:-$ROOT_DIR/cache/llama31_8b_align_usp_ulysses2_fix_grad}"
...
LOG_FILE="$LOG_DIR/llama31_8b_align_usp_ulysses2_fix_grad_${TIMESTAMP}.log"
...
if [ "${DISTRIBUTED_NODE_RANK:-0}" -eq 0 ]; then
    ...
    echo "=============================================="
    echo "TorchSpec Llama-3.1-8B USP alignment run (fix_grad)"
    echo "=============================================="
    ...
    echo "=============================================="
    echo "USP fix_grad training completed!"
    echo "=============================================="
else
