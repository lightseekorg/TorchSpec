...
RAY_LOG_ROOT="$WORKING_DIR/tmp/ray_usp_u2_fix_grad_proj_bf16_only_${DATE_TAG}_${LOG_SUFFIX}"
...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/llama31_8b_align_usp_ulysses2_fix_grad_proj_bf16_only}"
CACHE_DIR="${CACHE_DIR:-$ROOT_DIR/cache/llama31_8b_align_usp_ulysses2_fix_grad_proj_bf16_only}"
...
LOG_FILE="$LOG_DIR/llama31_8b_align_usp_ulysses2_fix_grad_proj_bf16_only_${TIMESTAMP}.log"
...
if [ "${DISTRIBUTED_NODE_RANK:-0}" -eq 0 ]; then
    ...
    echo "=============================================="
    echo "TorchSpec Llama-3.1-8B USP alignment run (fix_grad_proj_bf16_only)"
    echo "=============================================="
    ...
    python3 -m torchspec.train_entry \
      ...
      training.train_env_vars="'{\"TORCHSPEC_EAGLE3_PROJ_FP32\":\"0\"}'" \
    ...
    echo "=============================================="
    echo "USP fix_grad_proj_bf16_only training completed!"
    echo "=============================================="
else
